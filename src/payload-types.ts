...
export interface Document {
  ...
  /**
   * Project ID from external API
   */
  projectId: string;
  category?: ('requirements' | 'design' | 'development' | 'testing') | null;
  layoutJson?:
    | {
        [k: string]: unknown;
      }
...
export interface Layout {
  id: string;
  /**
   * Project ID from external API (e.g., prj_GEZopIYIWudzcPlJwMUOx2HBsdWx)
   */
  projectId: string;
  /**
   * Unique identifier path (e.g., /)
   */
  uid: string;
  /**
   ...
   */
  typeLayout: 'body' | 'header' | 'footer' | 'sidebar';
  /**
   * Layout identifier
   */
  layoutId: string;
  ...
  /**
   * Layout configuration JSON containing mobile and desktop layouts
   */
  layoutJson:
    | {
        [k: string]: unknown;
